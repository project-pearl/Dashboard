...
type SortBy = 'impact' | 'date' | 'domain';
...
export function PolicyTracker() {
  ...
  const filtered = useMemo(() => {
    ...
    switch (sortBy) {
      ...
      case 'domain':
        return [...list].sort((a, b) => a.pillars[0].localeCompare(b.pillars[0]));
      default:
        return list;
    }
  }, [pillarFilter, statusFilter, sortBy]);
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <select
            ...
            className="px-2.5 py-1 rounded text-xs font-medium bg-slate-100 text-slate-700 border border-slate-200 focus:outline-none focus:ring-1 focus:ring-indigo-400"
          >
          ...
          <select
            ...
            className="px-2.5 py-1 rounded text-xs font-medium bg-slate-100 text-slate-700 border border-slate-200 focus:outline-none focus:ring-1 focus:ring-indigo-400"
          >
            <option value="impact">Sort: By Impact Level</option>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-blue-200 mt-0.5">
                  ...
                  and Federal Register monitoring — delivered via Sentinel.
                </p>
              </div>
            </div>
          </div>
