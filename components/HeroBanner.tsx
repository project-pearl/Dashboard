...
export const heroConfigs: Record<string, HeroBannerConfig> = {
  ...
  state: {
    ...
    subtitle: 'State Regulatory Intelligence',
  ...
  esg: {
    ...
    subtitle: 'Corporate Water Stewardship',
  ...
  ngo: {
    image: '/images/heroes/Aerial.png',
    subtitle: 'Conservation Intelligence',
  ...
  pearl: {
    image: '/Pearl-Logo-alt.png',
    subtitle: 'Internal Operations',
    headline: 'PEARL Operations Command',
    description:
...
export default function HeroBanner({ role, className = '' }: HeroBannerProps) {
