...
const CHALLENGES: ChallengeBase[] = [
  {
    ...
    pearlCallout:
      'PEARL sensors track nitrate and phosphate in real time so communities can spot blooms early.',
  },
  {
    id: 'sediment',
    emoji: '🏔️',
    ...
    pearlCallout:
      'PEARL turbidity sensors detect sediment spikes after storms and construction activity.',
  },
  {
    id: 'bacteria',
    emoji: '🦠',
    ...
    pearlCallout:
      'PEARL continuously monitors indicator bacteria levels so health warnings can go out fast.',
  },
  {
    id: 'stormwater',
    emoji: '🌧️',
    ...
    pearlCallout:
      'PEARL tracks flow rates and pollutant surges during storms so cities can respond in real time.',
  },
  {
    id: 'microplastics',
    emoji: '🔬',
    ...
    pearlCallout:
      'PEARL helps researchers track where emerging contaminants concentrate in watersheds.',
  },
];
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="space-y-2">
          ...
          <div className={cn('rounded-lg border px-3 py-2 text-xs', p.callout)}>
            <span className={cn('font-semibold', p.calloutLabel)}>What PEARL does: </span>
            {c.pearlCallout}
          </div>
        </div>
      </div>
