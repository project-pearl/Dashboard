      ...
      await html2pdf()
        ...
        .then((pdf: any) => {
          ...
          pdf.setProperties({
            ...
            author: "PEARL Intelligence Network",
          ...
          for (let i = 1; i <= totalPages; i++) {
            ...
            pdf.text(
              "Generated by PEARL Intelligence Network (PIN). Not a regulatory determination, legal opinion, or engineering design.",
              0.4, 10.25,
            );
            pdf.text(
      ...
      <div ref={pdfRef} className="max-w-[900px] mx-auto px-6 py-8 space-y-8">
        ...
        <section className="exec-card bg-white rounded-xl p-5 border border-slate-200 shadow-sm">
          ...
          <div className="grid grid-cols-4 gap-3 mb-4">
            {[
              ...
              { l: "ALIA Teams", v: String(calc.teams), c: "text-slate-800" },
            ].map(x => (
          ...
          {calc.teams > 0 && (
            <div className="mt-4">
              ...
              <div className="flex justify-between py-1 border-b border-slate-100">
                <span className="text-[10px] text-slate-600">ALIA Teams ({calc.teams})</span>
          ...
          <div className={`rounded-xl p-5 border-2 ${calc.met ? "bg-green-50 border-green-300" : "bg-amber-50 border-amber-300"}`}>
            ...
            {!calc.met && (
              <div className="text-xs text-amber-700 leading-relaxed">
                <strong>Recommendations:</strong> Increase ALIA unit count, add source control modules
        ...
        <section className="exec-card border-t border-slate-200 pt-4">
          <div className="text-[9px] text-slate-400 leading-relaxed space-y-1">
            <p>
              <strong>Disclaimer:</strong> This treatment plan was generated by the PEARL Intelligence Network (PIN)
