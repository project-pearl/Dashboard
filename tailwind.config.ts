  ...
  theme: {
    extend: {
      fontSize: {
        ...
        'pin-xs': ['0.6875rem', { lineHeight: '1.5' }],
        'pin-sm': ['0.8125rem', { lineHeight: '1.5' }],
        'pin-base': ['0.9375rem', { lineHeight: '1.5' }],
        'pin-md': ['1.0625rem', { lineHeight: '1.5' }],
        'pin-lg': ['1.25rem', { lineHeight: '1.2' }],
        'pin-xl': ['1.5rem', { lineHeight: '1.2' }],
        'pin-2xl': ['1.875rem', { lineHeight: '1.2' }],
        'pin-3xl': ['2.25rem', { lineHeight: '1.2' }],
      },
      spacing: {
        'pin-1': '4px',
        'pin-2': '8px',
      ...
      colors: {
        ...
        pin: {
          ...
          'nominal-bg': 'var(--status-nominal-bg)',
        },
        chart: {
          '1': 'hsl(var(--chart-1))',
          '2': 'hsl(var(--chart-2))',
