...
export const DEFAULT_SECTIONS = {
  ...
  State: [
    ...
    { id: 'npdes-annual-report', label: 'NPDES Annual Report Generator', order: 79.5, visible: true, defaultExpanded: true,  lensControlled: true },
  ...
  FMC: [
    ...
    { id: 'force-protection-intel', label: 'Force Protection Intelligence',   order: 5.013, visible: true, defaultExpanded: true, lensControlled: true },
