...
export type CCKey = 'K12' | 'State' | 'Local' | 'MS4' | 'Sustainability' | 'NGO' | 'University' | 'FMC' | 'NCC'
  | 'Utility' | 'Infrastructure' | 'AQUA-LO' | 'SiteIntel' | 'Biotech' | 'Investor';
...
export const DEFAULT_SECTIONS = {
  K12: [
    ...
    { id: 'grants',      label: 'Grants — Currently Open & Best Fit',          order: 12, visible: true, defaultExpanded: true,  lensControlled: true },
    ...
    // ── Habitat & Ecology ──
    { id: 'hab-ecoscore',               label: 'Ecological Sensitivity Score', order: 18.1, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'hab-wildlife',               label: 'Wildlife & T&E Species',      order: 18.2, visible: true, defaultExpanded: true, lensControlled: true },
  ...
  State: [
    ...
    { id: 'pol-constituent-concerns', label: 'Constituent Concerns',        order: 19.42, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-funding-wins',        label: 'Funding Wins',                order: 19.43, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-funding-risks',       label: 'Funding Risks',               order: 19.44, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-regulatory-deadlines', label: 'Regulatory Deadlines',       order: 19.45, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-ej-exposure',         label: 'EJ Exposure Summary',         order: 19.46, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-media-ready-grades',  label: 'Media-Ready Grades',          order: 19.47, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-peer-comparison',     label: 'Peer Comparison',             order: 19.48, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-council-agenda',      label: 'Council Agenda Suggestions',  order: 19.49, visible: true, defaultExpanded: true, lensControlled: true },
    ...
    { id: 'flood-risk-overview', label: 'Flood Risk by Watershed',       order: 19.5, visible: true, defaultExpanded: true, lensControlled: true },
    ...
    { id: 'ph-mortality-context', label: 'National Mortality Context', order: 35.1, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'ph-healthcare-access', label: 'Healthcare Access Deserts', order: 35.2, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'ph-outbreak-tracker', label: 'Outbreak Surveillance',      order: 35.3, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'ph-env-health-corr',  label: 'Health-Environment Correlation', order: 35.4, visible: true, defaultExpanded: true, lensControlled: true },
    // ── Habitat (View 9) ──
    ...
    { id: 'mon-air-quality',     label: 'Air Quality Monitoring',       order: 55, visible: true, defaultExpanded: true,  lensControlled: true },
    { id: 'mon-latency',         label: 'Data Latency Tracker',         order: 56, visible: true, defaultExpanded: true,  lensControlled: true },
    { id: 'mon-report-card',     label: 'Data Report Card',             order: 57, visible: true, defaultExpanded: true,  lensControlled: true },
    ...
    { id: 'flood-risk-overview', label: 'Flood Risk by Watershed',       order: 62.6, visible: true, defaultExpanded: true, lensControlled: true },
    // ── TMDL (View 14) ──
    ...
    { id: 'wqt',                 label: 'Water Quality Trading',        order: 87.7, visible: true, defaultExpanded: true,  lensControlled: true },
    { id: 'usgs-ogc-stations',    label: 'USGS Monitoring Stations (OGC)', order: 87.81, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'ngwmn-groundwater',    label: 'Multi-Agency Groundwater (NGWMN)', order: 87.82, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'flood-impact-analysis', label: 'Flood Infrastructure Vulnerability', order: 87.83, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pfas-analytics-panel', label: 'PFAS National Analytics',      order: 87.84, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'nws-forecast-panel',   label: '7-Day Weather Forecast',       order: 87.85, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'water-availability',   label: 'Water Availability Assessment', order: 87.86, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'cyber-risk-panel',     label: 'Water System Cyber Risk',       order: 87.87, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'global-water-quality', label: 'Global Water Quality Context',  order: 87.88, visible: true, defaultExpanded: true, lensControlled: true },
    // ── Batch Data Sources (25 new integrations) ──
    { id: 'wqx-modern-results',  label: 'WQX 3.0 Water Quality',        order: 87.91, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'flood-event-viewer',  label: 'USGS Flood Event Viewer',      order: 87.92, visible: true, defaultExpanded: true, lensControlled: true },
  ...
  MS4: [
    ...
    { id: 'grants',              label: 'Grants — Currently Open & Best Fit',              order: 9,  visible: true, defaultExpanded: true,  lensControlled: true },
    ...
    { id: 'pol-constituent-concerns', label: 'Constituent Concerns',          order: 18.42, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-funding-wins',        label: 'Funding Wins',                  order: 18.43, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-funding-risks',       label: 'Funding Risks',                 order: 18.44, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-regulatory-deadlines', label: 'Regulatory Deadlines',         order: 18.45, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-ej-exposure',         label: 'EJ Exposure Summary',           order: 18.46, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-media-ready-grades',  label: 'Media-Ready Grades',            order: 18.47, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-peer-comparison',     label: 'Peer Comparison',               order: 18.48, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-council-agenda',      label: 'Council Agenda Suggestions',    order: 18.49, visible: true, defaultExpanded: true, lensControlled: true },
    ...
    // ── Habitat & Ecology ──
    { id: 'hab-ecoscore',        label: 'Ecological Sensitivity Score',     order: 33.1, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'hab-wildlife',        label: 'Wildlife & T&E Species',           order: 33.2, visible: true, defaultExpanded: true, lensControlled: true },
  ...
  Sustainability: [
    ...
    { id: 'facility-selector', label: 'Facility Selector',          order: 2.5, visible: true, defaultExpanded: true,  lensControlled: true },
    ...
    { id: 'grants',         label: 'Grants — Currently Open & Best Fit',           order: 15, visible: true, defaultExpanded: true,  lensControlled: true },
  ...
  Biotech: [
    ...
    { id: 'grants',               label: 'Grants — Currently Open & Best Fit',              order: 5,   visible: true, defaultExpanded: true,  lensControlled: true },
    ...
    { id: 'hab-wildlife',           label: 'Wildlife & T&E Species',         order: 15.2, visible: true, defaultExpanded: true, lensControlled: true },
    ...
    // ── Funding ──
    { id: 'fund-active',         label: 'My Active Grants',                 order: 34,  visible: true, defaultExpanded: true,  lensControlled: true },
  ...
  Investor: [
    ...
    { id: 'insights',                label: 'AI Insights Engine',               order: 4,   visible: true, defaultExpanded: true,  lensControlled: true },
    { id: 'grants',                  label: 'Grants — Currently Open & Best Fit',              order: 5,   visible: true, defaultExpanded: true,  lensControlled: true },
    { id: 'economic',                label: 'Economic Performance',             order: 6,   visible: true, defaultExpanded: true,  lensControlled: true },
    { id: 'groundwater',             label: 'Groundwater Monitoring (WDFN)',    order: 7,   visible: true, defaultExpanded: false, lensControlled: true },
    { id: 'trends-dashboard',        label: 'Trends & Forecasting',            order: 8,   visible: true, defaultExpanded: true,  lensControlled: true },
    ...
    { id: 'asset-exposure',          label: 'Asset Exposure Analysis',         order: 18,  visible: true, defaultExpanded: true,  lensControlled: true },
    { id: 'water-stress-map',        label: 'Water Stress Map',               order: 19,  visible: true, defaultExpanded: true,  lensControlled: true },
    { id: 'stressed-assets-table',   label: 'Stressed Assets Table',          order: 20,  visible: true, defaultExpanded: true,  lensControlled: true },
    { id: 'basin-analysis',          label: 'Basin Analysis',                  order: 21,  visible: true, defaultExpanded: true,  lensControlled: true },
    { id: 'compliance-overview',     label: 'Compliance Overview',             order: 22,  visible: true, defaultExpanded: true,  lensControlled: true },
    { id: 'regulatory-cost-forecast', label: 'Regulatory Cost Forecast',      order: 23,  visible: true, defaultExpanded: true,  lensControlled: true },
    { id: 'esg-scoring',             label: 'ESG Water Scoring',              order: 24,  visible: true, defaultExpanded: true,  lensControlled: true },
    { id: 'disclosure-readiness',    label: 'Disclosure Readiness',           order: 25,  visible: true, defaultExpanded: true,  lensControlled: true },
    { id: 'water-metrics-table',     label: 'Water Metrics Table',            order: 26,  visible: true, defaultExpanded: true,  lensControlled: true },
    { id: 'climate-scenarios',       label: 'Climate Scenarios',              order: 27,  visible: true, defaultExpanded: true,  lensControlled: true },
    { id: 'physical-risk-panel',     label: 'Physical Risk',                  order: 28,  visible: true, defaultExpanded: true,  lensControlled: true },
    { id: 'transition-risk-panel',   label: 'Transition Risk',                order: 29,  visible: true, defaultExpanded: true,  lensControlled: true },
    { id: 'financial-impact-summary', label: 'Financial Impact Summary',      order: 30,  visible: true, defaultExpanded: true,  lensControlled: true },
    { id: 'valuation-impact',        label: 'Valuation Impact',               order: 31,  visible: true, defaultExpanded: true,  lensControlled: true },
    { id: 'cost-of-inaction',        label: 'Cost of Inaction',               order: 32,  visible: true, defaultExpanded: true,  lensControlled: true },
  ...
  NGO: [
    ...
    { id: 'grants',      label: 'Grants — Currently Open & Best Fit',          order: 10, visible: true, defaultExpanded: true,  lensControlled: true },
    ...
    // ── Political Briefing ──
    { id: 'pol-talking-points',       label: 'Talking Points',              order: 15.1, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-constituent-concerns', label: 'Constituent Concerns',        order: 15.2, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-funding-wins',        label: 'Funding Wins',                order: 15.3, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-funding-risks',       label: 'Funding Risks',               order: 15.4, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-regulatory-deadlines', label: 'Regulatory Deadlines',       order: 15.5, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-ej-exposure',         label: 'EJ Exposure Summary',         order: 15.6, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-media-ready-grades',  label: 'Media-Ready Grades',          order: 15.7, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-peer-comparison',     label: 'Peer Comparison',             order: 15.8, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-council-agenda',      label: 'Council Agenda Suggestions',  order: 15.9, visible: true, defaultExpanded: true, lensControlled: true },
    ...
    // ── Habitat & Ecology ──
    { id: 'hab-ecoscore',                label: 'Ecological Sensitivity Score',  order: 21.1, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'hab-wildlife',                label: 'Wildlife & T&E Species',        order: 21.2, visible: true, defaultExpanded: true, lensControlled: true },
  ...
  University: [
    ...
    // ── Habitat & Ecology ──
    { id: 'hab-ecoscore',                 label: 'Ecological Sensitivity Score', order: 23.1, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'hab-wildlife',                 label: 'Wildlife & T&E Species',      order: 23.2, visible: true, defaultExpanded: true, lensControlled: true },
  ...
  FMC: [
    ...
    { id: 'fire-detection',      label: 'Fire Detection (NASA FIRMS)',    order: 5.07, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'fire-aq-intel',       label: 'Fire & AQ Intelligence',        order: 5.08, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'fire-aq-correlation', label: 'Fire-AQ Correlation Intelligence', order: 5.085, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'installation-risk-scorecard', label: 'Installation Risk Scorecard', order: 5.086, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'aqi-trend-chart',    label: 'AQI Trend Analysis',            order: 5.087, visible: true, defaultExpanded: true, lensControlled: true },
    ...
    { id: 'pol-funding-risks',       label: 'Funding Risks',               order: 5.54, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-regulatory-deadlines', label: 'Regulatory Deadlines',       order: 5.55, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-ej-exposure',         label: 'EJ Exposure Summary',         order: 5.56, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-media-ready-grades',  label: 'Media-Ready Grades',          order: 5.57, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-peer-comparison',     label: 'Peer Comparison',             order: 5.58, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-council-agenda',      label: 'Council Agenda Suggestions',  order: 5.59, visible: true, defaultExpanded: true, lensControlled: true },
    ...
    { id: 'ph-mortality-context', label: 'National Mortality Context', order: 24.1, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'ph-healthcare-access', label: 'Healthcare Access Deserts', order: 24.2, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'ph-outbreak-tracker', label: 'Outbreak Surveillance',      order: 24.3, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'ph-env-health-corr',  label: 'Health-Environment Correlation', order: 24.4, visible: true, defaultExpanded: true, lensControlled: true },
    ...
    { id: 'usgs-ogc-stations',    label: 'USGS Monitoring Stations (OGC)', order: 39.5, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'ngwmn-groundwater',    label: 'Multi-Agency Groundwater (NGWMN)', order: 39.6, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'flood-impact-analysis', label: 'Flood Infrastructure Vulnerability', order: 39.7, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pfas-analytics-panel', label: 'PFAS National Analytics',      order: 39.8, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'nws-forecast-panel',   label: '7-Day Weather Forecast',       order: 39.81, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'water-availability',   label: 'Water Availability Assessment', order: 39.82, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'cyber-risk-panel',     label: 'Water System Cyber Risk',       order: 39.83, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'global-water-quality', label: 'Global Water Quality Context',  order: 39.84, visible: true, defaultExpanded: true, lensControlled: true },
    // ── Batch Data Sources (25 new integrations) ──
    { id: 'wqx-modern-results',  label: 'WQX 3.0 Water Quality',        order: 39.91, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'flood-event-viewer',  label: 'USGS Flood Event Viewer',      order: 39.92, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'dmr-violations-panel', label: 'DMR Violation Analytics',     order: 39.93, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'hab-forecast-panel',  label: 'HAB Bloom Forecasts',          order: 39.94, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'cdc-places-health',   label: 'CDC PLACES Health Data',       order: 39.95, visible: true, defaultExpanded: true, lensControlled: true },
  ...
  Utility: [
    ...
    { id: 'grants',                 label: 'Grants — Currently Open & Best Fit',             order: 5.6, visible: true, defaultExpanded: true,  lensControlled: true },
    ...
    { id: 'pol-funding-wins',        label: 'Funding Wins',                order: 10.3, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-funding-risks',       label: 'Funding Risks',               order: 10.4, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-regulatory-deadlines', label: 'Regulatory Deadlines',       order: 10.5, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-ej-exposure',         label: 'EJ Exposure Summary',         order: 10.6, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-media-ready-grades',  label: 'Media-Ready Grades',          order: 10.7, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-peer-comparison',     label: 'Peer Comparison',             order: 10.8, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'pol-council-agenda',      label: 'Council Agenda Suggestions',  order: 10.9, visible: true, defaultExpanded: true, lensControlled: true },
    // ── Resolution Planner (View 3) ──
    ...
    // ── Habitat & Ecology ──
    { id: 'hab-ecoscore',           label: 'Ecological Sensitivity Score',    order: 35.1, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'hab-wildlife',           label: 'Wildlife & T&E Species',          order: 35.2, visible: true, defaultExpanded: true, lensControlled: true },
  ...
  Local: [
    ...
    { id: 'wqt',                  label: 'Water Quality Trading',      order: 45.5, visible: true, defaultExpanded: true,  lensControlled: true },
    ...
    // ── Habitat & Ecology ──
    { id: 'hab-ecoscore',          label: 'Ecological Sensitivity Score', order: 45.1, visible: true, defaultExpanded: true, lensControlled: true },
    { id: 'hab-wildlife',          label: 'Wildlife & T&E Species',      order: 45.2, visible: true, defaultExpanded: true, lensControlled: true },
    // ── Public Health (6) ──
    ...
    // ── Funding (8) ──
    { id: 'grants',                    label: 'Grants — Currently Open & Best Fit',         order: 50,  visible: true, defaultExpanded: true,  lensControlled: true },
