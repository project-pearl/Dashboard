...
export const DEFAULT_SECTIONS: Record<CCKey, SectionDefinition[]> = {
  ...
  MS4: [
    ...
    { id: 'map-grid',       label: 'Map & Waterbody List',          order: 4,  visible: true, defaultExpanded: true, compound: true },
    { id: 'detail',         label: 'Waterbody Detail',              order: 5,  visible: true, defaultExpanded: true },
    { id: 'mdeexport',      label: 'MDE Annual Reporting',          order: 6,  visible: true, defaultExpanded: true },
    { id: 'tmdl',           label: 'TMDL Compliance',               order: 7,  visible: true, defaultExpanded: true },
    { id: 'nutrientcredits', label: 'Nutrient Credit Tracking',     order: 8,  visible: true, defaultExpanded: true },
    { id: 'stormsim',       label: 'Storm Event Simulations',       order: 9,  visible: true, defaultExpanded: true },
    { id: 'economics',      label: 'Compliance Economics',          order: 10, visible: true, defaultExpanded: true },
    { id: 'top10',          label: 'Top 10 Priority Waterbodies',   order: 11, visible: true, defaultExpanded: false },
    { id: 'exporthub',      label: 'Data Export Hub',               order: 12, visible: true, defaultExpanded: true },
    { id: 'grants',         label: 'Grant Opportunities',           order: 13, visible: true, defaultExpanded: true },
    { id: 'provenance',     label: 'Data Provenance & Chain of Custody', order: 14, visible: true, defaultExpanded: true },
