...
export function brandedPrintSection(
  ...
  win.document.write(`<!DOCTYPE html><html><head><title>${title} — PEARL Intelligence Network</title>
    ...
    <div class="print-logo">
      <img src="/Pearl-Intelligence-Network.png" alt="PEARL Intelligence Network" onerror="this.style.display='none';document.getElementById('logo-fallback').style.display='block';" />
      <div id="logo-fallback" class="print-logo-fallback" style="display:none;">PEARL Intelligence Network</div>
    </div>
    ...
    <div class="print-content">${el.innerHTML /* Safe: el is an application-rendered DOM node, not user-supplied HTML */}</div>
    <div class="print-footer">Generated by PEARL Intelligence Network &mdash; pinwater.org</div>
  </body></html>`);
  win.document.close();
  setTimeout(() => {
    win.print();
