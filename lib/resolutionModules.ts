...
const SOURCE_CONTROL_MODULES: StrategyModule[] = [
  {
    ...
    title: 'Stormwater Retrofit & Green Infrastructure',
    description: 'Deploy bioretention cells, permeable pavements, green roofs, and rain gardens to capture and treat urban runoff at the source. Reduces peak flows and pollutant loading simultaneously.',
    icon: '🏗️',
  ...
  },
  {
    ...
    title: 'Agricultural BMP Implementation',
    description: 'Install cover crops, no-till practices, nutrient management plans, and field buffers to reduce nonpoint source loading from agricultural land.',
    icon: '🌾',
  ...
  },
  {
    ...
    description: 'Apply erosion blankets, silt fences, sediment basins, and slope stabilization during construction and on disturbed lands to prevent soil loss.',
    icon: '🚧',
  ...
  },
  {
    ...
    description: 'Systematic outfall screening, dye testing, and source tracing to identify and eliminate illicit connections to the storm sewer system.',
    icon: '🔍',
  ...
  },
  {
    ...
    title: 'Pet & Wildlife Waste Management',
    description: 'Install pet waste stations, enhance signage, and manage waterfowl populations near impaired waterways to reduce bacteria loading.',
    icon: '🐕',
    triggerCauses: ['pathogen', 'bacteria', 'e. coli', 'fecal', 'enterococ'],
    loadReductionRange: '10-30% bacteria in targeted areas',
    timeline: '0-6 months', costTier: '$', costNote: '$5K-$25K per park/area',
    applicabilityBase: 10,
  },
  {
    id: '1.6', categoryId: 'source-control',
    title: 'Road Salt & De-icing Optimization',
    description: 'Calibrate salt application rates, use brine pre-wetting, and establish salt storage best practices to reduce chloride loading to waterways.',
    icon: '🧂',
    triggerCauses: ['chloride', 'conductivity', 'salinity'],
    loadReductionRange: '20-40% chloride loading',
    timeline: '0-6 months', costTier: '$', costNote: '$10K-$100K program startup',
    applicabilityBase: 5,
  },
  {
    id: '1.7', categoryId: 'source-control',
    title: 'Industrial Pretreatment & Pollution Prevention',
    description: 'Strengthen pretreatment requirements for industrial dischargers, implement pollution prevention plans, and upgrade treatment technologies at source.',
    icon: '🏭',
  ...
  {
    id: '1.8', categoryId: 'source-control',
    title: 'Septic System Management & Conversion',
    description: 'Mandate inspections, pump-out schedules, and conversion to sewer or advanced treatment where failing septic systems contribute bacteria and nutrients.',
    icon: '🏠',
