...
const SOURCE_CONTROL_MODULES: StrategyModule[] = [
  {
    ...
    icon: '🏗️',
    dataSources: ['ATTAINS impairment data', 'NLCD impervious cover', 'MS4 outfall inventory', 'WDFN stream gauges'],
  ...
  },
  {
    ...
    icon: '🌾',
    dataSources: ['USDA Cropland Data Layer', 'ATTAINS impairment data', 'WDFN nutrient monitoring', 'CEAP edge-of-field data'],
...
const NATURE_BASED_MODULES: StrategyModule[] = [
  ...
  },
  {
    ...
    icon: '🌊',
    dataSources: ['NHDPlus flowlines', 'USGS dam inventory', 'FEMA floodplain maps', 'WDFN stream gauges'],
  ...
  },
  {
    ...
    icon: '🏞️',
    dataSources: ['NHDPlus stream network', 'ATTAINS biological impairments', 'WDFN sediment data', 'LiDAR terrain models'],
...
const PEARL_MODULES: StrategyModule[] = [
  ...
  },
  {
    ...
    icon: '📡',
    dataSources: ['PEARL unit telemetry', 'WDFN real-time gauges', 'WQP continuous monitoring', 'Weather forecast API'],
