...
// Aqua-LO appears under DATA & LABS in the sidebar.
// Lab users (LAB_DIRECTOR, LAB_ANALYST) land on /aqua-lo.
//
// Usage:
...
export const federalNav: NavItem[] = [
  ...
  // 2. Operational — dive into action
  { label: 'Compliance',
  ...
  // 3. Threats & Monitoring — "what threats exist" then "are we watching"
