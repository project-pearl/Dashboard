...
export class BrandedPDFGenerator {
  ...
  async loadLogo(): Promise<void> {
    return new Promise((resolve, reject) => {
      ...
      img.src = '/Pearl-Intelligence-Network.png';
    });
  }
  ...
  private addTextHeader() {
    ...
    this.doc.text('PEARL Intelligence Network', this.pageWidth / 2, 15, { align: 'center' });
  ...
  private addFooter(pageNum: number, totalPages: number) {
    ...
    const footerText = 'Generated by PEARL Intelligence Network -- project-pearl.org | Real-time water quality monitoring';
