...
export class BrandedPDFGenerator {
  ...
  private addTextHeader() {
    ...
    this.doc.text('PIN — PEARL Intelligence Network', this.pageWidth / 2, 15, { align: 'center' });
  ...
  private addFooter(pageNum: number, totalPages: number) {
    ...
    const footerText = 'Generated by PIN — pinwater.org | Real-time water quality monitoring';
