...
const MD_WATERWAYS: WaterwayCentroid[] = [
  ...
  { lat: 39.2580, lon: -76.5930, keywords: ['middle branch', 'middle br'] },
  { lat: 39.2750, lon: -76.5280, keywords: ['back river'] },
  { lat: 39.2850, lon: -76.6700, keywords: ['gwynns falls', 'gwynn'] },
  { lat: 39.2450, lon: -76.5450, keywords: ['bear creek'] },
  { lat: 39.2830, lon: -76.6100, keywords: ['inner harbor'] },
  { lat: 39.3100, lon: -76.6100, keywords: ['jones falls'] },
  { lat: 39.2200, lon: -76.5600, keywords: ['stony creek'] },
  { lat: 39.2700, lon: -76.5050, keywords: ['frog mortar'] },
  { lat: 39.2350, lon: -76.5700, keywords: ['curtis creek', 'curtis bay'] },
  { lat: 39.2150, lon: -76.5400, keywords: ['marley creek', 'marley'] },
  { lat: 39.2600, lon: -76.5800, keywords: ['colgate creek'] },
  { lat: 39.3050, lon: -76.5850, keywords: ['herring run'] },
  { lat: 39.3200, lon: -76.6000, keywords: ['chinquapin'] },
  { lat: 39.2680, lon: -76.6050, keywords: ['baltimore harbor'] },
  { lat: 39.2600, lon: -76.6200, keywords: ['northwest harbor'] },
  { lat: 39.2550, lon: -76.5350, keywords: ['bread and cheese'] },
  { lat: 39.3400, lon: -76.5100, keywords: ['dundee creek', 'dundee'] },
  { lat: 39.2900, lon: -76.6300, keywords: ['stony run'] },
  { lat: 39.2400, lon: -76.5900, keywords: ['furnace creek'] },
  { lat: 39.2300, lon: -76.5100, keywords: ['lynch cove'] },

  // ── Patapsco system ──
  { lat: 39.2500, lon: -76.6200, keywords: ['patapsco'] },
  { lat: 39.3200, lon: -76.7400, keywords: ['north branch patapsco'] },
  { lat: 39.2800, lon: -76.7600, keywords: ['south branch patapsco'] },
  { lat: 39.3000, lon: -76.7800, keywords: ['morgan run'] },
  { lat: 39.3500, lon: -76.8200, keywords: ['liberty reservoir', 'liberty res'] },
  { lat: 39.2600, lon: -76.8400, keywords: ['piney run'] },

  // ── Gunpowder / Loch Raven ──
  { lat: 39.4200, lon: -76.5000, keywords: ['gunpowder'] },
  { lat: 39.4300, lon: -76.5500, keywords: ['loch raven'] },
  { lat: 39.4600, lon: -76.4300, keywords: ['deer creek'] },
  { lat: 39.3800, lon: -76.4600, keywords: ['little gunpowder'] },
  { lat: 39.5000, lon: -76.5800, keywords: ['prettyboy'] },
  { lat: 39.3500, lon: -76.4800, keywords: ['winters run'] },
  { lat: 39.4000, lon: -76.5300, keywords: ['bird river'] },
  ...
  { lat: 39.4800, lon: -77.5200, keywords: ['catoctin'] },
  ...
  { lat: 39.0700, lon: -77.1600, keywords: ['cabin john'] },
  { lat: 39.4200, lon: -77.3500, keywords: ['fishing creek'] },
  { lat: 39.3800, lon: -77.4000, keywords: ['linganore'] },
  { lat: 39.5200, lon: -77.3200, keywords: ['double pipe', 'pipe creek'] },
  { lat: 39.4800, lon: -77.0800, keywords: ['little bennett'] },
  { lat: 39.6500, lon: -77.7200, keywords: ['north branch potomac'] },
  ...
  { lat: 38.9800, lon: -76.9500, keywords: ['paint branch'] },
  { lat: 38.9900, lon: -76.9700, keywords: ['sligo creek', 'sligo'] },
  { lat: 38.8800, lon: -76.9600, keywords: ['indian creek'] },
  { lat: 38.8500, lon: -76.9900, keywords: ['oxon run', 'oxon'] },
  { lat: 38.8200, lon: -76.9800, keywords: ['henson creek'] },
  { lat: 38.7500, lon: -77.0500, keywords: ['mattawoman'] },
  { lat: 38.7000, lon: -77.0800, keywords: ['piscataway'] },
  { lat: 38.6500, lon: -76.9500, keywords: ['broad creek'] },
  { lat: 38.5500, lon: -76.9200, keywords: ['zekiah'] },
  ...
  { lat: 38.9600, lon: -76.5400, keywords: ['severn'] },
  { lat: 39.0800, lon: -76.4800, keywords: ['magothy'] },
  { lat: 38.9200, lon: -76.4800, keywords: ['south river'] },
  { lat: 38.8500, lon: -76.5200, keywords: ['rhode river'] },
  { lat: 38.8200, lon: -76.5000, keywords: ['west river'] },
  { lat: 38.9500, lon: -76.4800, keywords: ['spa creek'] },
  { lat: 38.9400, lon: -76.4900, keywords: ['college creek'] },
  { lat: 38.9300, lon: -76.5100, keywords: ['weems creek'] },
  { lat: 39.1600, lon: -76.4600, keywords: ['bodkin'] },
  ...
  { lat: 39.0500, lon: -76.7800, keywords: ['dorsey run'] },

  // ── Calvert / St. Mary's / Charles ──
  { lat: 38.7200, lon: -76.5300, keywords: ['herring bay'] },
  { lat: 38.5500, lon: -76.5200, keywords: ['st. leonard', 'st leonard'] },
  { lat: 38.5200, lon: -76.5500, keywords: ['battle creek'] },
  { lat: 38.4800, lon: -76.5800, keywords: ['hunting creek'] },
  { lat: 38.3000, lon: -76.5800, keywords: ['breton bay'] },
  { lat: 38.2000, lon: -76.4500, keywords: ["st. mary's", "st mary"] },
  { lat: 38.3200, lon: -76.5200, keywords: ['st. clement', 'st clement'] },
  { lat: 38.4500, lon: -77.0000, keywords: ['nanjemoy'] },
  { lat: 38.4000, lon: -76.8500, keywords: ['wicomico r'] },
  { lat: 38.3500, lon: -76.6500, keywords: ['mcintosh'] },
  { lat: 38.3800, lon: -76.4000, keywords: ['smith creek'] },

  // ── Eastern shore — upper (Cecil, Kent, QA) ──
  { lat: 39.5500, lon: -75.9500, keywords: ['elk river', 'elk r'] },
  { lat: 39.5200, lon: -75.8800, keywords: ['northeast river', 'northeast r'] },
  { lat: 39.4800, lon: -75.9200, keywords: ['principio'] },
  { lat: 39.0200, lon: -75.9800, keywords: ['sassafras'] },
  { lat: 39.5000, lon: -75.8000, keywords: ['bohemia'] },
  { lat: 39.1500, lon: -76.0500, keywords: ['chester river', 'chester r'] },
  { lat: 39.0800, lon: -76.0800, keywords: ['langford'] },
  { lat: 39.1200, lon: -76.1200, keywords: ['morgan creek'] },
  { lat: 38.9800, lon: -76.2500, keywords: ['corsica'] },
  { lat: 38.9200, lon: -76.1200, keywords: ['wye'] },
  ...
  { lat: 38.7200, lon: -76.1500, keywords: ['tred avon'] },
  { lat: 38.7500, lon: -76.1000, keywords: ['harris creek'] },
  { lat: 38.8800, lon: -76.1000, keywords: ['tuckahoe'] },
  { lat: 38.7000, lon: -75.9000, keywords: ['kings creek'] },
  { lat: 38.5200, lon: -76.1500, keywords: ['fishing bay'] },
  { lat: 38.4800, lon: -76.1800, keywords: ['honga'] },
  { lat: 38.4500, lon: -76.0800, keywords: ['blackwater'] },
  { lat: 38.6500, lon: -76.0200, keywords: ['marshyhope'] },
  { lat: 38.6800, lon: -75.8500, keywords: ['greensboro'] },

  // ── Eastern shore — lower (Wicomico, Somerset, Worcester) ──
  { lat: 38.4500, lon: -75.8800, keywords: ['nanticoke'] },
  { lat: 38.3800, lon: -75.8200, keywords: ['rewastico'] },
  { lat: 38.3800, lon: -76.0500, keywords: ['wicomico'] },
  { lat: 38.1500, lon: -75.5500, keywords: ['pocomoke'] },
  { lat: 38.2000, lon: -75.8500, keywords: ['manokin'] },
  { lat: 38.1200, lon: -75.9500, keywords: ['big annemessex', 'annemessex'] },
  { lat: 38.3200, lon: -75.6200, keywords: ['dividing creek'] },
  { lat: 38.0800, lon: -75.3800, keywords: ['tangier sound'] },
...
const VA_WATERWAYS: WaterwayCentroid[] = [
  { lat: 36.8500, lon: -76.2800, keywords: ['elizabeth'] },
  { lat: 37.1000, lon: -76.4500, keywords: ['james'] },
  { lat: 37.6000, lon: -76.8500, keywords: ['rappahannock'] },
  { lat: 37.2500, lon: -76.5500, keywords: ['york'] },
  { lat: 36.8800, lon: -76.0800, keywords: ['lynnhaven'] },
  { lat: 38.7000, lon: -77.8500, keywords: ['shenandoah'] },
  { lat: 37.3500, lon: -79.9500, keywords: ['new river'] },
  { lat: 37.5500, lon: -77.4500, keywords: ['chickahominy'] },
  { lat: 36.7500, lon: -76.5500, keywords: ['nansemond'] },
  { lat: 37.0000, lon: -76.3500, keywords: ['hampton roads'] },
  { lat: 38.3000, lon: -77.4500, keywords: ['potomac creek', 'aquia'] },
  { lat: 37.2800, lon: -76.8000, keywords: ['mattaponi'] },
  { lat: 37.6500, lon: -76.4000, keywords: ['corrotoman'] },
  { lat: 37.4000, lon: -76.0000, keywords: ['piankatank'] },
  ...
  { lat: 37.5000, lon: -79.4500, keywords: ['roanoke'] },
  { lat: 36.7000, lon: -79.9000, keywords: ['dan river'] },
  { lat: 36.8500, lon: -82.0000, keywords: ['clinch'] },
  { lat: 36.7500, lon: -82.5000, keywords: ['powell'] },
  { lat: 36.6500, lon: -81.8000, keywords: ['holston'] },
  { lat: 36.9500, lon: -76.4200, keywords: ['lafayette'] },
  { lat: 37.0500, lon: -76.3000, keywords: ['back river'] },
  { lat: 36.8000, lon: -76.1500, keywords: ['little creek'] },
];
...
const DC_WATERWAYS: WaterwayCentroid[] = [
  ...
  { lat: 38.8500, lon: -76.9900, keywords: ['oxon'] },
  { lat: 38.9100, lon: -76.9500, keywords: ['watts branch'] },
  { lat: 38.8700, lon: -77.0100, keywords: ['hickey run'] },
  { lat: 38.9400, lon: -77.0100, keywords: ['klingle'] },
...
const PA_WATERWAYS: WaterwayCentroid[] = [
  { lat: 40.0400, lon: -76.3000, keywords: ['conestoga'] },
  { lat: 40.4500, lon: -76.5800, keywords: ['swatara'] },
  ...
  { lat: 40.0500, lon: -76.4500, keywords: ['pequea'] },
  { lat: 40.1500, lon: -76.7500, keywords: ['conewago'] },
  { lat: 39.8800, lon: -76.5500, keywords: ['octoraro'] },
  { lat: 39.9500, lon: -77.3000, keywords: ['conococheague'] },
  { lat: 40.3500, lon: -76.8800, keywords: ['paxton'] },
  { lat: 40.7500, lon: -76.8000, keywords: ['mahantango'] },
  { lat: 40.0000, lon: -76.2000, keywords: ['mill creek'] },
...
const DE_WATERWAYS: WaterwayCentroid[] = [
  ...
  { lat: 39.6500, lon: -75.6500, keywords: ['white clay'] },
  { lat: 38.6800, lon: -75.3500, keywords: ['indian river'] },
  { lat: 38.5800, lon: -75.0800, keywords: ['rehoboth'] },
  { lat: 39.1500, lon: -75.5000, keywords: ['smyrna'] },
  { lat: 39.5500, lon: -75.7000, keywords: ['elk'] },
  { lat: 38.7800, lon: -75.4000, keywords: ['nanticoke'] },
...
const WV_WATERWAYS: WaterwayCentroid[] = [
  ...
  { lat: 39.1800, lon: -77.8200, keywords: ['shenandoah'] },
  { lat: 39.4500, lon: -78.0500, keywords: ['south branch'] },
  ...
  { lat: 38.4200, lon: -80.6500, keywords: ['greenbrier'] },
  { lat: 39.3000, lon: -80.3500, keywords: ['tygart'] },
  { lat: 39.2800, lon: -78.8500, keywords: ['cacapon'] },
  { lat: 39.5000, lon: -79.4500, keywords: ['north branch'] },
  { lat: 38.7500, lon: -81.2000, keywords: ['elk river'] },
  { lat: 38.0500, lon: -80.7500, keywords: ['new river'] },
  { lat: 39.4500, lon: -78.9500, keywords: ['potomac'] },
];

// ─── Florida ──────────────────────────────────────────────────────────────────

const FL_WATERWAYS: WaterwayCentroid[] = [
  { lat: 30.4200, lon: -87.2100, keywords: ['escambia'] },
  ...
  { lat: 30.3500, lon: -86.8500, keywords: ['blackwater'] },
  { lat: 30.6000, lon: -87.0500, keywords: ['perdido'] },
  { lat: 30.3700, lon: -87.0000, keywords: ['east bay'] },
  { lat: 30.4000, lon: -86.6000, keywords: ['choctawhatchee'] },
  { lat: 30.3000, lon: -85.8000, keywords: ['st. andrew', 'st andrew'] },
  { lat: 29.9000, lon: -81.3000, keywords: ['st. johns', 'st johns'] },
  { lat: 28.0500, lon: -80.6000, keywords: ['indian river'] },
  { lat: 25.1000, lon: -80.9000, keywords: ['everglades'] },
  { lat: 26.1500, lon: -81.8000, keywords: ['caloosahatchee'] },
  { lat: 30.4800, lon: -86.9500, keywords: ['milton', 'santa rosa'] },
  { lat: 28.5500, lon: -81.3800, keywords: ['kissimmee'] },
  ...
  { lat: 30.1500, lon: -84.2000, keywords: ['apalachicola'] },
  { lat: 29.6500, lon: -82.3000, keywords: ['suwannee'] },
  { lat: 25.7500, lon: -80.1500, keywords: ['biscayne'] },
  { lat: 25.3500, lon: -80.9500, keywords: ['florida bay'] },
];
...
const NY_WATERWAYS: WaterwayCentroid[] = [
  ...
  { lat: 42.4500, lon: -76.5000, keywords: ['cayuga'] },
  { lat: 42.0500, lon: -75.9000, keywords: ['chenango'] },
  { lat: 42.3500, lon: -77.0500, keywords: ['cohocton'] },
  { lat: 42.1500, lon: -75.9500, keywords: ['tioughnioga'] },
];
