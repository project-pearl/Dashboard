...
const LENS_DOMAINS: Record<string, DomainKey[]> = {
  ...
  'public-health':        ['ejscreen', 'airQuality'],
  ...
  'scorecard':            ['echo', 'attains', 'dam', 'usdm', 'fema', 'airQuality'],
  'overview':             ['echo', 'attains', 'fema', 'usdm'],
  'briefing':             ['echo', 'attains', 'fema', 'usdm'],
  ...
  'trends':               ['echo', 'attains'],
  'policy':               ['echo', 'attains'],
  'political-briefing':   ['echo', 'attains', 'fema'],
  'reports':              ['echo', 'attains'],
  'interagency':          ['echo', 'attains', 'fema'],
};
