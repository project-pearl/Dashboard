...
export default function DataProvenancePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Section nav — sticky horizontal bar */}
      <div className="sticky top-0 z-30 bg-white/95 backdrop-blur border-b border-slate-200 px-6 py-2 print:hidden">
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-4 overflow-x-auto flex-1">
            <span className="text-sm font-semibold text-slate-800 whitespace-nowrap">Data Confidence</span>
          ...
          <button
            onClick={handlePrint}
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md border border-slate-300 text-xs font-medium text-slate-600 hover:bg-slate-50 transition-colors flex-shrink-0"
          >
            <Printer size={13} />
            Print
          </button>
